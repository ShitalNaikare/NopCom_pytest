...
class Test_Login_DDT:
    ...
    Excel_File_Path = "C:\\Users\\Admin\\PycharmProjects\\nopcom_pytest\\Test_Data\\Test_Data.xlsx"
    ...
    def test_user_login_DDT_005(self, setup):
        ...
        for r in range(2, self.rows + 1):  # iteration r = 2
            ...
            if self.lp.Verify_Login_Status() == "Login Pass":  # actual Result # login hogaya
                ...
                if self.Expected_Result == "Pass":  # expected result
                    ...
                    self.log.info("Click on Logout button")
                    self.lp.Click_LogoutButton()
            elif self.lp.Verify_Login_Status() == "Login Fail":  # login nhi hua
